...
#define PIN_NUM_MISO 25		// SPI MISO - SDO
#define PIN_NUM_MOSI 23		// SPI MOSI - SDA
#define PIN_NUM_CLK  19		// SPI CLOCK pin - SCL
#define PIN_NUM_CS   22		// Display CS pin - CS
#define PIN_NUM_DC   21		// Display command/data pin - D/C
#define PIN_NUM_TCS   0		// Touch screen CS pin

#define PIN_NUM_RST  18  	// GPIO used for RESET control - RESET
#define PIN_NUM_BCKL  5     // GPIO used for backlight control - Backlight
...
#define PIN_NUM_MISO 32		// SPI MISO
